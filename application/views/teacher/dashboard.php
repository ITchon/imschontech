				...
				<div class="col-md-12">
					<div class="panel panel-midnightblue">
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-6">
                                    <img src="<?php echo base_url() ?>./assets/demo/avatar/watson.png" class="pull-left" style="margin: 0 20px 20px 0">
									<div class="table-responsive">
										<table class="table table-condensed">
                                            
											<h3><strong><?php echo $tp->fname." ".$tp->lname ?></strong></h3>
											<!-- <thead>
												<tr>
													<th width="50%"></th>
													<th width="50%"></th>
											...
											<tbody>
												...
												<tr>
													<td>Email</td>
													<td><a href=""><?php echo $tp->email?></a></td>
												</tr>
												<tr>
													<td>Phone</td>
													<td><?php echo $tp->tel?></td>
												</tr>
												<tr>
													<td>Position</td>
													<td>Designer</td>
