...
<br>
                ...
                <div class="row">
                    <h3>Label Buttons</h3>
                    <p>Adding a <code>.btn-label</code> class to the button will increase focus on the attached icon</p>
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th>Color Classes</th>
                                <th>Button Colors</th>
                                <th>Color Classes Alt</th>
                                <th>Button Colors Alt</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><code>.btn-primary.btn-label</code></td>
                                <td><button class="btn btn-primary btn-label"><i class="fa fa-check"></i> Primary</button></td>
                                <td><code>.btn-primary-alt.btn-label</code></td>
                                <td><button class="btn btn-primary-alt btn-label"><i class="fa fa-check"></i> Primary</button></td>
                            </tr>
                            <tr>
                                <td><code>.btn-success.btn-label</code></td>
                                <td><button class="btn btn-success btn-label"><i class="fa fa-download"></i> Success</button></td>
                                <td><code>.btn-success-alt.btn-label</code></td>
                                <td><button class="btn btn-success-alt btn-label"><i class="fa fa-download"></i> Success</button></td>
                            </tr>
                            <tr>
                                <td><code>.btn-info.btn-label</code></td>
                                <td><button class="btn btn-info btn-label"><i class="fa fa-bookmark"></i> Info</button></td>
                                <td><code>.btn-info-alt.btn-label</code></td>
                                <td><button class="btn btn-info-alt btn-label"><i class="fa fa-bookmark"></i> Info</button></td>
                            </tr>
                            <tr>
                                <td><code>.btn-warning.btn-label</code></td>
                                <td><button class="btn btn-warning btn-label"><i class="fa fa-cog"></i> Warning</button></td>
                                <td><code>.btn-warning-alt.btn-label</code></td>
                                <td><button class="btn btn-warning-alt btn-label"><i class="fa fa-cog"></i> Warning</button></td>
                            </tr>
                            <tr>
                                <td><code>.btn-danger.btn-label</code></td>
                                <td><button class="btn btn-danger btn-label"><i class="fa fa-times"></i> Danger</button></td>
                                <td><code>.btn-danger-alt.btn-label</code></td>
                                <td><button class="btn btn-danger-alt btn-label"><i class="fa fa-times"></i> Danger</button></td>
                            </tr>
                            <tr>
                                <td><code>.btn-inverse.btn-label</code></td>
                                <td><button class="btn btn-inverse btn-label"><i class="fa fa-check"></i> Inverse</button></td>
                                <td><code>.btn-inverse-alt.btn-label</code></td>
                                <td><button class="btn btn-inverse-alt btn-label"><i class="fa fa-check"></i> Inverse</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
