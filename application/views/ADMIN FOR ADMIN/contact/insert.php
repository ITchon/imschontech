                ...
                <div class="col-md-12">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <h4>เพื่มรายชื่อผู้คุมการฝึกงาน</h4>
                        </div>
                        <div class="panel-body collapse in">
                                <?php echo form_open('manage_contact/insert_p');?>
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        <?php echo form_submit(array('teacher_id'=>'submit','value'=>' ยีนยัน ','class'=>'btn-primary btn')); 
