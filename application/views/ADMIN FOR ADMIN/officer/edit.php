                ...
                <div class="col-md-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body collapse in">
                                <?php echo form_open('manage_officer/edit_officer_p');?>
                                <div class="row">
                                <?php echo form_hidden('officer_id',$result[0]->officer_id);  ?>
                                    <div class="col-md-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="of_birth_date" value="<?php echo $result[0]->of_birth_date ?>" class="form-control">
                                            </select>
                                        </div>
                                    </div>
                                </div>    
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="of_code">รหัสครู</label>
                                            <input type="text" name="of_code" value="<?php echo $result[0]->of_code ?>" class="form-control">
