        ...
        <ul class="nav navbar-nav pull-right toolbar">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu userinfo arrow">
                    <li class="username">
                        <a href="#">
                            <div class="pull-left"><img class="userimg" src="<?php echo base_url(); ?>assets/demo/avatar/dangerfield.png" alt="Jeff Dangerfield"/></div>
    ...
    <nav class="navbar navbar-default yamm" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" id="horizontal-navbar">
            <ul class="nav navbar-nav">
                <li class="active"><a href="<?php echo base_url(); ?>layout/layout_hori2"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
                <li><a href="<?php echo base_url();?>main"><i class="fa fa-columns"></i> <span>Layout</span></a></li>
                <li><a href="<?php echo base_url();?>main"><i class="fa fa-group"></i> <span>Members</span></a></li>
                <li><a href="<?php echo base_url();?>main"><i class="fa fa-pencil"></i> <span>Components</span></a></li>
