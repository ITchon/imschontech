...
<div class="verticalcenter">
	<div class="panel panel-primary" id="sheder">
		<div class="panel-body">
			<h3 class="text-center" style="margin-bottom: 25px;">กรุณาเปลี่ยนรหัสผ่านใหม่</h3>
				<form action="<?php echo base_url() ?>Login/save_new_pass" class="form-horizontal" style="margin-bottom: 0px !important;" method="post">
						...
						<div class="form-group">
							<div class="col-sm-12">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-key"></i></span>
									<input type="password" class="form-control" name="password2" id="password2" placeholder="Comfirm password" required>
								</div>
							</div>
						</div>
