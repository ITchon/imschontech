...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/styles.css?=120">
    ...
    <nav class="navbar navbar-default yamm" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse large-icons-nav" id="horizontal-navbar">
            <ul class="nav navbar-nav">
                <li class="active"><a href="l<?php echo base_url(); ?>layout"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
