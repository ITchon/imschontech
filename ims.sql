...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2021 at 08:28 AM
...
(404, '', '', '', '2021-03-15 00:00:00', '0000-00-00 00:00:00', 15, 1, 0),
(405, '', '', '', '2021-03-10 00:00:00', '0000-00-00 00:00:00', 15, 0, 0),
(407, 'dasda', '', '', '2021-03-10 06:00:00', '0000-00-00 00:00:00', 15, 0, 0);
...
(47, 'การตรงต่อเวลา'),
(48, 'เข้าใจขั้นตอน'),
(49, 'ปฏิบัติงานด้วยความรอบคอบและปลอดภัย');
...
INSERT INTO `supervision_contact` (`spv_contact_id`, `t_id`, `subject_id`, `approve_date`) VALUES
(14, 11, 12, '2021-03-10'),
(15, 11, 12, '2021-03-10'),
(16, 0, 0, '2021-03-10'),
(17, 11, 12, '2021-03-10'),
...
(11, 16, 15, 9, 3, '2022-01-01', '2022-04-08', '', ''),
...
--
ALTER TABLE `group_list`
  MODIFY `glist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `subject_score`
  MODIFY `ss_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `supervision_contact`
--
ALTER TABLE `supervision_contact`
  MODIFY `spv_contact_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
